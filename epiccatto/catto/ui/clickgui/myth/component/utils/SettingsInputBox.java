package epiccatto.catto.ui.clickgui.myth.component.utils;
...
public class SettingsInputBox extends Gui {
    ...
    public SettingsInputBox(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) FontLoaders.Sfui16.drawStringWithShadow(text, xPosition + 5, yPosition + 6, -1);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int) FontLoaders.Sfui16.drawString(s.substring(j), (float) j1, (float) i1, i);
            }

            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, new Color(50, 50, 50).getRGB());
                } else {
                    FontLoaders.Sfui16.drawString("_", (float) k1 + 2, (float) i1, i);
                }
            }
        ...
        //FontLoaders.Sfui19.drawStringWithShadow(text, xPosition, yPosition, -1);
    }
