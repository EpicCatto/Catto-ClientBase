package catto.uwu.utils.render.blur;

import catto.uwu.utils.render.blur.filter.GaussianFilter;
...
public class BlurProcessor {
    ...
    public BlurProcessor(final boolean oldBlur) {
    ...
    public void blur(final double x, final double y, final double areaWidth, final double areaHeight, final boolean setupOverlayRendering, final boolean bloom, final boolean reverseBloom, final int bloomRadius, final int bloomAlpha, final boolean ignoreModule, final float blurStrength) {
    ...
    public void blur(final double x, final double y, final double areaWidth, final double areaHeight, final boolean setupOverlayRendering, final boolean ignoreModule) {
        this.blur(x, y, areaWidth, areaHeight, setupOverlayRendering, false, false, 0, 0, ignoreModule, 10);
    }
    ...
    public void blur(final double x, final double y, final double areaWidth, final double areaHeight, float blurStrength) {
...
//    }
    ...
    public void bloom(final int x, final int y, final int width, final int height, final int blurRadius, final int color) {
