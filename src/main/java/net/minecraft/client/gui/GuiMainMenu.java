...
import catto.uwu.ui.alts.GuiAltsManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        {
            this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Alts", new Object[0])));
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        {
//            this.f();
            mc.displayGuiScreen(new GuiAltsManager(this));
        }
