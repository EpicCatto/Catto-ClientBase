...
public class RenderUtils {
    ...
    public static void drawGradientRect(final int left, final int top, final int right, final int bottom, final int startColor, final int endColor) {
        ...
        worldrenderer.pos(right, top, RenderUtils.zLevel).color(f2, f3, f4, f).endVertex();
        worldrenderer.pos(left, top, RenderUtils.zLevel).color(f2, f3, f4, f).endVertex();
        worldrenderer.pos(left, bottom, RenderUtils.zLevel).color(f6, f7, f8, f5).endVertex();
        worldrenderer.pos(right, bottom, RenderUtils.zLevel).color(f6, f7, f8, f5).endVertex();
        tessellator.draw();
    ...
    public static void drawImage(double x, double y, final int width, final int height, final ResourceLocation image, Color color) {
        ScaledResolution scaledResolution = new ScaledResolution(Minecraft.getMinecraft());
        GL11.glDisable(2929);
        GL11.glEnable(3042);
        GL11.glDepthMask(false);
